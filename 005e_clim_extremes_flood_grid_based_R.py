...
gcms = ['CNRM-CERFACS-CNRM-CM5','CSIRO-BOM-ACCESS1-0']
...
#for val in enumerate(values[0]):  
    ...
    for i in range (0, len(grid_cells)): 
        try:
            ...
            LOGGER.info('Error in hist timeseries') 
        ...
        try:
            ...
            LOGGER.info('Error in future timeseries')    
            scenario_yT_point = math.nan
            continue # it means next iteration        
...
output_file = 'ds_flood_plot_%s_e.csv' % (which_cluster)
